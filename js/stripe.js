...
export const STRIPE_PRODUCTS = {
  ...
  agency5_monthly:   { mode: 'subscription', amount: 13497, label: 'Agency 5 (monthly)',     price_id: 'price_1Tn4WeGo0WwBpBOqkh8lHd47' },
  agency5_annual:    { mode: 'subscription', amount: 153866,label: 'Agency 5 (annual)',      price_id: 'price_ag5_y' },
  agency10_monthly:  { mode: 'subscription', amount: 21697, label: 'Agency 10 (monthly)',    price_id: 'price_1Tn4XhGo0WwBpBOqokb4sXrg' },
  agency10_annual:   { mode: 'subscription', amount: 247346,label: 'Agency 10 (annual)',     price_id: 'price_ag10_y' },
  brandwide_monthly: { mode: 'subscription', amount: 10797, label: 'Brand Wide (monthly)',   price_id: 'price_1Tn4ZRGo0WwBpBOqX0TLdMCh' },
  brandwide_annual:  { mode: 'subscription', amount: 123088,label: 'Brand Wide (annual)',    price_id: 'price_bw_y' },
  single_megisto_krator_addon: { mode: 'payment',      amount: 700,   label: 'Single Site — Megisto + Krator Add-on', price_id: 'price_single_mk_addon' },
  pro_krator_monthly:          { mode: 'subscription', amount: 3797,  label: 'Pro + Krator (monthly)',                price_id: 'price_pro_krator_m' },
  pro_krator_annual:           { mode: 'subscription', amount: 43285, label: 'Pro + Krator (annual)',                 price_id: 'price_pro_krator_y' },
